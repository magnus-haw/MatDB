    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_instance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='materials.materialpropertyinstance')),
            ],
            options={
